...
<section id="products" style="background:var(--deep);border-top:1px solid var(--hair);border-bottom:1px solid var(--hair)" data-push><div class="wrap">
  ...
  <div class="grid-3" style="margin-top:64px" data-rise=".prod">${PRODUCTS.map(prodCard).join('')}</div>
</div></section>
...
<section class="light" data-push><div class="wrap">
