...
function renderPublications(data) {
  ...
  <div class="panel">
    ...
    <div class="prow">
      ...
      <label>L'essentiel (ce que vous voulez dire)<textarea id="p-ess" placeholder="Ex. Rabais de 15 % sur les pneus d'hiver jusqu'au 30 novembre."></textarea></label>
    </div>
...
var tmr; ess.addEventListener('input',function(){clearTimeout(tmr);tmr=setTimeout(apercu,300);});
...
document.getElementById('p-add').addEventListener('click', async function(){
  ...
  return page({
    ...
    active: 'publications', source: data.source, pass: data.pass,
